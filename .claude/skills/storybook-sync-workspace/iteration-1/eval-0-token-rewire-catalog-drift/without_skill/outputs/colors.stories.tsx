 ...
 * Foundations / Colors
 *
 * Displays every color token exposed via the `@theme inline` block in
 * `globals.css`. Each swatch renders the live `var(--token)` value, so toggling
...
const GROUPS: TokenGroup[] = [
  ...
  },
  {
    title: "Component",
    description:
      "Per-component color knobs (tier 3). Default to their semantic role, but a theme can override one to restyle a single component.",
    tokens: [
