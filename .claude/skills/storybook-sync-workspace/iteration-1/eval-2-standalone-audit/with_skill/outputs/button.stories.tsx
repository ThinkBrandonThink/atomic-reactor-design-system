...
export const IconOnly: Story = {
  ...
  render: (args) => (
    <div className="flex flex-wrap items-center gap-3">
      <Button {...args} size="icon-xs" aria-label="Add item">
        <Plus />
      </Button>
...
const colorTokens = [
  { name: "--button-bg", affects: "Default variant background (defaults to --primary)" },
  { name: "--button-fg", affects: "Default variant text (defaults to --primary-foreground)" },
