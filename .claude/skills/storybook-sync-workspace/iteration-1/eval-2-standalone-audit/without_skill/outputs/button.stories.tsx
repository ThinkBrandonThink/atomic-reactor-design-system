...
const colorTokens = [
  {
    name: "--button-bg",
    affects: "Default variant background (tier-3 knob; defaults to --primary)",
  },
  {
    name: "--button-fg",
    affects: "Default variant text (tier-3 knob; defaults to --primary-foreground)",
  },
  {
    name: "--button-bg-hover",
    affects: "Default variant hover background (tier-3 knob)",
  },
  ...
  { name: "--primary-link", affects: "Link variant text" },
  {
    name: "--destructive",
...
const radiusTokens = [
  {
    name: "--button-radius",
    affects: "Default/lg/icon corner radius (tier-3 knob; defaults to --radius-lg)",
  },
